    ...
    <div class="container mt-5">
        <div class="text-center">
            <div class="col-md-6 p-lg-5 mx-auto my-5">
                <img src="{{asset('img/periodontoloji.jpg')}}" alt="BackgroundImage" class="img-fluid">
                <h1 class="display-3 fw-bold">Periodontoloji </h1>
            </div>
        </div>
        <div class="container mt-5">
            <div class="row">
